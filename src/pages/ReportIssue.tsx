...
const ReportIssue = () => {
    ...
    const [ngosWithMatchingInterests, setNgosWithMatchingInterests] = useState<string[]>([]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (file) {
                ...
                const storageRef = ref(storage, `issues/${user.uid}/${file.name}`);
    ...
    useEffect(() => {
        const fetchNgos = async () => {
            const db = getFirestore(app);
            const q = query(collection(db, "users"), where("role", "==", "ngo"), where("interests", "array-contains", formData.category));
                        ...
                        >
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div {...getRootProps()} className={cn("border-2 border-dashed border-muted-foreground/20 rounded-lg p-4 text-center cursor-pointer hover:bg-muted/50 transition-colors", isDragActive && "ring-2 ring-primary ring-offset-1")}>
                                        <input {...getInputProps()} />
                                ...
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex items-start">
                                    ...
                                    <p className="text-sm text-yellow-700">
                                        All reports are reviewed by our team. Please provide accurate information to help us address the issue effectively.
                                    </p>
                                </div>
